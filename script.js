...
let alguien = ['Mi vecino', 'Mi perro', 'Mi hermano', 'Mi jefe', 'Mi sobrino', 'Mi hamster', 'Mi compañero de clase', 'Mi abuelo', 'El panadero del barrio', 'El frutero de la esquina'];
...
let quasiAdverbio = ['de forma apresurada', 'sin pestañear', 'porque sí', 'sin yo saberlo', 'sin darse cuenta'];
